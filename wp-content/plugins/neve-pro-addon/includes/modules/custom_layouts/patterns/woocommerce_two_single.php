<?php
/**
 * Pattern for WooCommerce Single Once Column Variation Two.
 *
 ...
 */
class Woocommerce_Two_Single extends Abstract_Pattern {
	...
	protected function define_pattern_props() {
		$this->namespace   = 'woocommerce-one-single-two-pattern';
		$this->title       = __( 'WooCommerce Single Variation Two Layout', 'neve' );
...
<div class="wp-block-themeisle-blocks-advanced-columns-overlay"></div>
<div class="innerblocks-wrap">
<!-- wp:themeisle-blocks/advanced-column {"id":"wp-block-themeisle-blocks-advanced-column-ab5cbb6e","columnWidth":"100"} --><div id="wp-block-themeisle-blocks-advanced-column-ab5cbb6e" class="wp-block-themeisle-blocks-advanced-column">
<!-- wp:post-content /-->
</div><!-- /wp:themeisle-blocks/advanced-column -->
</div>
</div><!-- /wp:themeisle-blocks/advanced-columns -->
