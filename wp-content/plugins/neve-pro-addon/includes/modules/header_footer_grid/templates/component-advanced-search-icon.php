...
/**
 * Filters advanced search component icon styles.
 *
 * @since 2.2.0
 *
 * @param array<string, string> $styles_array The styles array.
 */
$component_styles_array = apply_filters( 'neve_advanced_search_component_icon_styles', [] );
...
<div class="nv-search-icon-component" <?php echo wp_kses_post( $component_styles ); ?>>
	<div <?php echo $amp_class; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, Already escaped. ?> class="menu-item-nav-search <?php echo esc_attr( $open ); ?>">
		<?php neve_search_icon( true, true, 15, ! empty( $amp_state ), 'hfg' ); ?>
